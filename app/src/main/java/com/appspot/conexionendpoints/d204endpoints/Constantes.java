...
public class Constantes {
    ...
    public static final String URL_LOCAL = "http://10.0.2.2:8080";
    public static final String URL_REMOTA = "https://conexionendpoints.appspot.com";
    public static final String EXTRA_ID = "com.appspot.conexionendpoints.d204endpoints.ID";
